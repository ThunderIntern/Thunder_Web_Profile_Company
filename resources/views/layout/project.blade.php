    ...
    <div class="container-fluid">
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-12">
            <ul class="nav navbar-nav">
                ...
                <li  class="li2"><a href="#"></a><span class="spritelogo ielogo"></span></li>
...
<section class="content-section text-center">
  ...
  <div class="row">
    <div class="text-center">
      <button class="button">Join Our Squad</button>
    </div>
  </div>
</section>
<section class="content-section text-center">
  ...
  <div class="content">
      <div class="row">
        <div class="col-md-4"><h1 >HOTEL</h1><a href="http://hotelriverstone.com/" class="tech">http://hotelriverstone.com/</a></div>
  <div class="col-md-8"><img src="image/hotel.jpg"></div>
</div>
<div class="row">
  <div class="col-md-8"><img src="image/edukasi.jpg"></div>
  <div class="col-md-4"><h1>EDUKASI</h1><a href="https://bloom.id/" class="tech">https://bloom.id/</a></div>
</div>
<div class="row">
...
<div class="row">
  ...
  <div class="col-md-4"><h1>TRAVEL</h1><a href="http://www.tamasyahati.com/" class="tech">http://www.tamasyahati.com/</a><br><a href="http:/capcus.id" class="tech">http:/capcus.id</a></div>
</div>
<div class="row">
  <div class="col-md-4"><h1>PORTAL</h1><a href="http://halomalang.com" class="tech">http://halomalang.com<br><a href="http://gopego.com" class="tech">http://gopego.com/</a></div>
  <div class="col-md-8"><img src="image/portal.jpg"></div>
</div>
<div class="row">
  <div class="col-md-8"><img src="image/e-commerce.jpg"></div>
  <div class="col-md-4"><h1>E-COMMERCE</h1><a href="http://balin.id/" class="tech">http://balin.id/</a></div>
</div>
<div class="row">
  <div class="col-md-4"><h1>HR</h1><a href="http://www.reliance-insurance.com/" class="tech">http://www.reliance-insurance.com/</a></div>
